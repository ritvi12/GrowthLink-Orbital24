...
import { EventsProvider, useEventsContext } from '../assets/EventsContext';
...
describe('EventContext', () => {
  ...
  test('renders and provides context values', async () => {
    ...
    // Validate initial context values
  ...
  test('bookmarks an event', async () => {
    ...
    // Validate document update and toast notification
  ...
  test('adds a post', async () => {
    ...
    // Validate document addition and toast notification
  ...
  test('deletes a post', async () => {
    ...
    // Validate document deletion and toast notification
